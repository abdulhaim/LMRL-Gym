...
```
environment: 8/8/7Q/2k5/8/8/K7/8 w - - 2 2
action: Qh4

environment: 8/8/3k4/8/7Q/8/K7/8 w - - 4 3
action: Qg5

environment: 8/2k5/8/6Q1/8/8/K7/8 w - - 6 4
action: Kb1
...
if __name__ == "__main__":
    # N_INTERACTIONS = 1
    OUTPUTS_PATH = "data/outputs/gpt4_endgames/"
    ...
    test_positions = test_positions[:100]
    ...
    interaction_raw_results, interaction_summary_results = text_env_eval_chess_positions(
