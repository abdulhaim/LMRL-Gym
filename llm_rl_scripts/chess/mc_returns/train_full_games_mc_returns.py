...
def main(
    ...
    policy_max_input_length: int=150, 
    policy_max_output_length: int=10, 
    ...
    mc_data = mc_data_generator(train_data_path)
    
    dataset = MCIterableDataset.from_mc_data_iterable(mc_data, tokenizer,
                                          BlockingStrategy(
